...
For this reason, we propose that Gorssel could negotiate with Deventer to advocate that Overijssel consider policies with more flood protection measures, to mitigate this uncertainty in damage outcomes.
