...
\section{Assumptions}
Here, a selection of important assumptions made during the analysis and problem framing are listed:
...
\begin{itemize}
    ...
    \item Overijssel consists out of only Deventer and Gorssel/Lochem
...
\end{tabular}
\caption{Preliminary Assessment of Actor preferences preceding the first debate}
\label{t:objectives}
\end{table}